...
import { ProductTablePaginationProps } from "@/features/manageProducts/types/manageProduct.type";

export const ProductTablePagination: React.FC<ProductTablePaginationProps> = ({
  meta,
  onPageChange,
}) => {
