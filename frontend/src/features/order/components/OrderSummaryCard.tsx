...
export const OrderSummaryCard: React.FC<Props> = ({ totalPrice, totalFinalPrice }) => {
    const totalSaving = totalPrice - totalFinalPrice
    const savingPercentage = ((totalPrice - totalFinalPrice) / totalFinalPrice) * 100
