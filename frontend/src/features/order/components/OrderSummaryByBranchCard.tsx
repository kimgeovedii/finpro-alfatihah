    ...
    return (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 w-full mb-4">
            <div className="sm:col-span-2 lg:col-span-1 bg-white border border-slate-200 rounded-2xl p-6 flex flex-col justify-between min-h-[140px]">
                <StatsTitleValueText title="Total Revenue Monthly" val={<>Rp {totalRevenue.toLocaleString(currencyFormat)}</>}/>
                {
                    revenueChangePercent !== 0 && 
                        <div className="flex items-center gap-1 mt-2 text-teal-600 text-sm font-medium">
                            <span>+{revenueChangePercent.toFixed(1)}% vs last month</span>
                        </div>
                }
            </div>
            <div className="bg-blue-500 rounded-2xl p-6 flex flex-col justify-between text-white min-h-[140px]">
            ...
            <div className="bg-emerald-500 rounded-2xl p-6 flex flex-col justify-between text-white min-h-[140px]">
